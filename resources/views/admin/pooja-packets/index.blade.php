...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            ...
            <p class="text-slate-500 mt-1">
                Manage package photo, flowers, quantity, MRP,
                sale price and package duration.
            </p>
        </div>

        <a
            href="{{ route('admin.pooja-packets.create') }}"
    ...
    <div class="grid md:grid-cols-3 gap-4">
        ...
        <div class="bg-white border border-red-100 rounded-2xl p-5 shadow-sm">
            ...
            <h2 class="text-3xl font-black text-red-500 mt-1">
                {{ $stats['inactive'] }}
            </h2>
        </div>
    </div>
    ...
    <form
        method="GET"
        action="{{ route('admin.pooja-packets.index') }}"
        ...
        <div class="grid md:grid-cols-5 gap-4">
            ...
            <div>
                ...
                >
                    ...
                    <option
                        value="Three Month"
                        {{ ($packageType ?? '') === 'Three Month' ? 'selected' : '' }}
                    >
                        Three Month
                    </option>
                    ...
                    <option
                        value="Six Month"
                        {{ ($packageType ?? '') === 'Six Month' ? 'selected' : '' }}
                    >
                        Six Month
                    </option>
            ...
            <div class="flex items-end gap-2">
                <button
                    type="submit"
                    class="w-full bg-slate-900 hover:bg-slate-800 text-white px-4 py-3 rounded-xl font-bold transition"
                >
                    Filter
                </button>

                <a
                    href="{{ route('admin.pooja-packets.index') }}"
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                <thead class="bg-orange-50 border-b border-orange-100">
                    <tr>
                        <th class="p-4 text-left text-slate-700">
                            Package
                        </th>
                        ...
                        <th class="p-4 text-center text-slate-700">
                            Type
                        </th>
                ...
                <tbody>
                    @forelse($packets as $packet)
                        @php
                            ...
                            /*
                             * Important:
                             * Use image_url instead of asset($packet->image).
                             */
                        ...
                        <tr class="border-b border-slate-100 hover:bg-orange-50/40 transition">
                            <td class="p-4">
                                <div class="flex items-center gap-3">
                                    <div class="relative w-14 h-14 min-w-14 rounded-2xl bg-orange-50 border border-orange-100 overflow-hidden flex items-center justify-center">
                                        ...
                                        @if($imageUrl)
                                            ...
                                            <span
                                                class="absolute inset-0 items-center justify-center text-orange-500 font-black text-xl"
                                                style="display: none;"
                                            >
                                                🌸
                                            </span>
                            ...
                            <td class="p-4">
                                <div class="flex flex-wrap gap-1">
                                    @forelse($packet->flower_items as $item)
                            ...
                            <td class="p-4 text-center">
                                <div class="flex justify-center items-center gap-2">
                                    <a
                                        href="{{ route('admin.pooja-packets.edit', $packet) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="p-10 text-center">
                                <div class="text-slate-400 text-lg font-bold">
                                    No packages found.
                                </div>
